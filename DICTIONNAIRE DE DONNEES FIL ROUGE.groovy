...
RUBRIQUE	Id rubrique	                rubrique_id	                                          AUTO_INCREMENT
	Nom rubrique	                    rubrique_nom	                                      VARCHAR(255)
	Description rubrique	            rubrique_desc	                                      VARCHAR(255)
    Photo rubrique                      rubrique_photo                                        VARCHAR(255)

SOUS-RUBRIQUE	Id de sous rubrique	    sousrub_id	                                          VARCHAR(50)
	Nom de sous rubrique	            sousrub_nom	                                          VARCHAR(50)
	Description de sous rubrique	    sousrub_desc	                                      VARCHAR(255)
    Photo de sous rubrique              sousrub_photo                                         VARCHAR(255)
